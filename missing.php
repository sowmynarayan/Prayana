...
<body>
	...
	<!-- the path to redemption doesn't start here --> 
		...
		<!--  Each time the clue or the answer sounds easier but not this time  -->
...
<div id="main_container">
    ...
    <div id="center_content">
    		<div class="left_content">
                    ...
                    <br />
		    <h3>I was all time with them -  5545637 -  in a tree house - 
                    <br />and accompanied them in adventures...
                    <br />But still many ignore me and others get the whole credit...</h3>
                    <br />
                    <br />
                    <h1>reteptenajkcajnilocegroegmaparabrab</h1>
                    <br />
                    <h3>Answer : </h3>
