...
<body>
	...
	<!-- the path to redemption doesn't start here --> 
		...
		<!-- "It is not what we take up but what we give up that makes us rich" -H.W.B -->
...
<div id="main_container">
	...
	<div id="header">
       ...
       <a href="index.php">Prayana'10</a>
		...
		<a href="index.php" >home</a></li>
                ...
                <li><a href="logout_verify.php">logout</a>
                </li>
              	</ul>
        </div>
    ...
    <div id="center_content">
    		<div class="left_content">
                    ...
                    <h1>Level 13</h1>
                    <img src="images/paine.jpg">
                    <br/ >
                    Answer : 
			<form action="max_verify.php" method = "post">
