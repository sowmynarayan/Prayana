...
<body>
	...
	<!-- the path to redemption doesn't start here --> 
		...
		<!-- If you think the logic you can win it in a magic -->
...
<div id="main_container">
    ...
    <div id="center_content">
    		<div class="left_content">
                    ...
                    <br />
                    <h3>If everyone thinks alike, none can get through this level...
                    <br>
                    If you are different, then success is at your door...!</h3>
                    <h3>Answer : </h3>
