...
<body>
	...
	<!-- the path to redemption doesn't start here --> 
		...
		<!-- Correct the mistakes before he finds out -->
    ...
    <div id="center_content">
    		<div class="left_content">
                    ...
                    <p style = "font-size: 20px"><em>
                    		fedrer is te champon! casilas is our hero! dhone is our mn!
                    <h3>Answer : </h3>
			<form action="levelx_verify.php" method = "post">
